class Simulation {
    ...
    static create() {
        ...
        ParticleSystemFirework.create(this.nb_particules, this.radiusParticles, this.opacityParticles);
    ...
    static animate(time) {
        ...
        if (fps < Simulation.fpsMin) {
            ...
            if (Simulation.lowFpsCount >= Simulation.maxLowFps) {
                 ...
                 */
                Simulation.nb_particules = Math.max(1000, Math.floor(ParticleSystemFirework.particles.length / 1.25));
...
*/
    static updateParticleTtlMax(dureeDeVieMaxi) {
        if(dureeDeVieMaxi >= this.ttlMin){
            ...
            for(let particle of ParticleSystemFirework.particles){
